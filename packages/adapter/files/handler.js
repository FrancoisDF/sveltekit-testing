...
//#endregion
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.38.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@3.1.2_svelte@5.38._6d5mrq4iqmgmgher4yvj2wgwxi/node_modules/@sveltejs/kit/src/exports/internal/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/@sveltejs+kit@2.38.1_@opentelemetry+api@1.9.0_@sveltejs+vite-plugin-svelte@3.1.2_svelte@5.38._6d5mrq4iqmgmgher4yvj2wgwxi/node_modules/@sveltejs/kit/src/exports/node/index.js
/**
		...
		start(controller) {
			...
			req.on("data", (chunk) => {
				...
				if (size > content_length) {
					cancelled = true;
					const message = `request body size exceeded ${content_length ? "content-length" : "BODY_SIZE_LIMIT"} of ${content_length}`;
					const error = new SvelteKitError(413, "Payload Too Large", message);
					controller.error(error);
					return;
				}
...
function serve_prerendered() {
	const handler$1 = serve(path.join(dir, "prerendered"));
	return (req, res, next) => {
		let { pathname, search, query } = parse(req);
		try {
			pathname = decodeURIComponent(pathname);
		} catch {}
		if (prerendered.has(pathname)) return handler$1(req, res, next);
